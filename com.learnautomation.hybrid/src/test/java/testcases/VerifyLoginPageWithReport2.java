...
public class VerifyLoginPageWithReport2 {
	...
	public void testHomePage()
	{
	    ...
	    login.loginApplication("yash.dewangan82@gmail.com", "landu18");
	    
	    logger.log(LogStatus.INFO, "long in to application");
	    
	    login.verifySignOutLink();
	    
	    logger.log(LogStatus.INFO,logger.addScreenCapture(Helper.captureScreenshot(driver, "validation test 1 ")));
